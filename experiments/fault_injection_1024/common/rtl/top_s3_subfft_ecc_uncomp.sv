...
// ============================================================================
// SC-01 方案B: un-compensated S3 top (added 2026-08-10).
// Stages 1-8 use ecc_stage4_v5_uncomp (raw-syndrome threshold corrector, no
// residual compensation); stages 9-10 keep the original TMR stages.
// ============================================================================
module subfft_ecc_core_v5_uncomp #(
...
wire lo_detected_unused0,lo_corrected_unused0,lo_uncorrectable_unused0;wire[2:0]lo_error_location_unused0;
wire lo_detected_unused1,lo_corrected_unused1,lo_uncorrectable_unused1;wire[2:0]lo_error_location_unused1;
wire lo_detected_unused2,lo_corrected_unused2,lo_uncorrectable_unused2;wire[2:0]lo_error_location_unused2;
wire lo_detected_unused3,lo_corrected_unused3,lo_uncorrectable_unused3;wire[2:0]lo_error_location_unused3;
wire lo_detected_unused4,lo_corrected_unused4,lo_uncorrectable_unused4;wire[2:0]lo_error_location_unused4;
wire lo_detected_unused5,lo_corrected_unused5,lo_uncorrectable_unused5;wire[2:0]lo_error_location_unused5;
wire lo_detected_unused6,lo_corrected_unused6,lo_uncorrectable_unused6;wire[2:0]lo_error_location_unused6;
wire lo_detected_unused7,lo_corrected_unused7,lo_uncorrectable_unused7;wire[2:0]lo_error_location_unused7;
...
ecc_stage4_v5_uncomp #(.DEPTH(128),.STAGE(1),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s1(
 ...
 lo_detected_unused0,lo_corrected_unused0,lo_uncorrectable_unused0,lo_error_location_unused0
);
ecc_stage4_v5_uncomp #(.DEPTH(64),.STAGE(2),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s2(
 ...
 lo_detected_unused1,lo_corrected_unused1,lo_uncorrectable_unused1,lo_error_location_unused1
);
ecc_stage4_v5_uncomp #(.DEPTH(32),.STAGE(3),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s3(
 ...
 lo_detected_unused2,lo_corrected_unused2,lo_uncorrectable_unused2,lo_error_location_unused2
);
ecc_stage4_v5_uncomp #(.DEPTH(16),.STAGE(4),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s4(
 ...
 lo_detected_unused3,lo_corrected_unused3,lo_uncorrectable_unused3,lo_error_location_unused3
);
ecc_stage4_v5_uncomp #(.DEPTH(8),.STAGE(5),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s5(
 ...
 lo_detected_unused4,lo_corrected_unused4,lo_uncorrectable_unused4,lo_error_location_unused4
);
ecc_stage4_v5_uncomp #(.DEPTH(4),.STAGE(6),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s6(
 ...
 lo_detected_unused5,lo_corrected_unused5,lo_uncorrectable_unused5,lo_error_location_unused5
);
ecc_stage4_v5_uncomp #(.DEPTH(2),.STAGE(7),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s7(
 ...
 lo_detected_unused6,lo_corrected_unused6,lo_uncorrectable_unused6,lo_error_location_unused6
);
ecc_stage4_v5_uncomp #(.DEPTH(1),.STAGE(8),.PFFT_MODE(0),.THRESHOLD(THRESHOLD))s8(
 ...
 lo_detected_unused7,lo_corrected_unused7,lo_uncorrectable_unused7,lo_error_location_unused7
);
...
module top_s3_subfft_ecc_uncomp #(
 parameter integer THRESHOLD = 8
)(
 input wire clk,input wire rst,input wire in_valid,input wire in_last,
 input wire signed[34:0]in0_re,in0_im,in1_re,in1_im,in2_re,in2_im,in3_re,in3_im,
...
subfft_ecc_core_v5_uncomp #(.THRESHOLD(THRESHOLD)) u(
